...
import { 
  ...
  ExternalLink, FlaskConical, Info, Sparkles, Download, Stethoscope, Briefcase
} from 'lucide-react';
...
// --- GENERADOR DE vCARD (NUEVA FUNCIONALIDAD) ---
...
// --- COMPONENTE INTERNO: TARJETA DE MISIÓN DEL HUB (EXISTENTE) ---
const HubInfoCard = () => (
    ...
    <div className="h-full overflow-y-auto p-4 md:p-6 bg-slate-50/30">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div className="px-6 pb-6 text-center relative">
                    <div className="-mt-14 mb-4 inline-block p-1.5 bg-white rounded-2xl shadow-lg ring-4 ring-slate-50">
                        <div className="w-28 h-28 bg-slate-100 rounded-xl flex items-center justify-center overflow-hidden border border-slate-200">
                            {profile?.logo_url ? <img src={profile.logo_url} className="w-full h-full object-cover"/> : <span className="text-4xl font-bold text-slate-300">{profile?.full_name?.charAt(0)}</span>}
                        </div>
                    </div>
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            {/* COMPONENTE NUEVO: Perla Clínica */}
            <ClinicalPearlCard />
            
            {/* TARJETA EXISTENTE: HubInfoCard (Como alternativa o complemento) */}
            <HubInfoCard />
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden p-6 relative">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 z-10 relative">
                    {[{name:'Vademécum', url:'https://www.medicamentosplm.com/', icon:BookOpen}, {name:'Calculadoras', url:'https://www.mdcalc.com/', icon:Activity}, {name:'CIE-10 OMS', url:'https://icd.who.int/', icon:FileText}, {name:'CENETEC Guías', url:'https://cenetec-difusion.com/', icon:Globe}].map((t, i) => (
